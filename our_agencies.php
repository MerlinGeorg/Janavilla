...
<?php	  $s104="SELECT * from our_agencies_page";
 ...
 $res04=$sl04->fetch(PDO::FETCH_ASSOC);
  ...
  ?>	
			...
			<h1 id="tit-eng" class="entry-title draw-a-line-standby">
										Our Agencies						
			</h1>

<h1 id="tit-arab" class="entry-title draw-a-line-standby">
										جلة ج
...
<div class="container clearfix">	<div class="page-contents-wrap  ">
		...
		<div id="post-10038" class="post-10038 page type-page status-publish hentry">
         ...
         <!-- eng -->
					<div id="eng-ag" class="entry-page-wrapper entry-content clearfix">
					

                    <ul>
                    	 <?php
        $submenu = $res2["submenu_id"];
        $s33="SELECT * from agencies where agencies_status = '1' ";
        $sl33=$db->prepare($s33);
        $sl33->execute();
 ...
 while($res5=$sl33->fetch(PDO::FETCH_ASSOC))
 {
	 ...
	 ?>
                    	<li style="margin-bottom: 35px">
                    		<div class="col-md-12" style="background: #797676;opacity: .7">
                    		<div>	
                    		<h2 class="col-md-12" style="text-align: left;margin-left: 60px;opacity: 0.9"><b><?php echo $res5["agencies_name"] ?></b></h2>
                    		<div class="col-md-12" style="margin-left: 40px">
                    		<p style="color: #ffff"><?php echo $res5["agencies_desc"] ?></p>
                    		<p style="color: #ee513d"><b>Check product Catlog<a target="blank" href="admin/uploads/<?php echo $res5["agencies_file"] ?>"> here</a></b></p>
                    	    </div>
                    	    </div>
                    	    </div>
                    	</li>
   <?php } ?>
        ...
        <!-- eng -->
        <!-- arab -->
										<div id="arab-ag" class="entry-page-wrapper entry-content clearfix">
 ...
 while($res5=$sl33->fetch(PDO::FETCH_ASSOC))
 {
	 ...
	 ?>
                    	<li style="margin-bottom: 35px">
                    		<div class="col-md-12" style="background: #797676;opacity: .7">
                    		<div>	
                    		<h2 class="col-md-12" style="text-align: left;margin-left: 60px;opacity: 0.9"><b><?php echo $res5["agencies_name_arab"] ?></b></h2>
                    		<div class="col-md-12" style="margin-left: 40px">
                    		<p style="color: #ffff"><?php echo $res5["agencies_desc_arab"] ?></p>
                    		<p style="color: #ee513d"><b>Check product Catlog<a target="blank" href="admin/uploads/<?php echo $res5["agencies_file"] ?>"> here</a></b></p>
                    	    </div>
                    	    </div>
                    	    </div>
       ...
       $('#tit-eng').show();
		...
		jQuery(function($){	
			jQuery.supersized({
				...
				slides 					:  	[
		{image : 'images/bg6.jpeg', title : '<div class="fullscreen-slideshow-color" data-color="bright"></div><div class="slideshow-content-wrap background-slideshow-controls"><h1 class="slideshow_title slideshow_text_shift_up slideshow_title_animation">back-duvar-unitesi</h1></div>', thumb : '', url : ''}				],
				progress_bar			:	1,					
				mouse_scrub				:	1
			});
			if ($.fn.swipe) {
