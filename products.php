<?php include('header.php') ?>
    ...
    <?php $subcat = $_GET['subid'];
      // echo $subcat; 

    
        
        $s2="SELECT * from category where category_id = '$subcat' Limit 1";
        $sl2=$db->prepare($s2);
        $sl2->execute();

 while($res3=$sl2->fetch(PDO::FETCH_ASSOC))
 {
    ...
    ?>
			...
			<h1 id="catt-eng" class="entry-title draw-a-line-standby">
				<?php echo $res3["category_name"]; ?>	 											
			</h1>
			<h1 id="catt-arab" class="entry-title draw-a-line-standby">
				<?php echo $res3["category_name_arab"]; ?>	 											
			</h1>
			<div id="catd-eng" class="entry-title-subheading"><?php echo $res3["category_desc"]; ?></div>	
			<div id="catd-arab" class="entry-title-subheading"><?php echo $res3["category_desc_arab"]; ?></div>	
			<?php } ?>	
		</div>

			</div>
</div>
</div><div class="container clearfix" style="min-height: 300px">	<div class="page-contents-wrap  ">
			
		<div id="post-9698" class="post-9698 page type-page status-publish hentry">

					<div class="entry-page-wrapper entry-content clearfix">
					<div id="mtheme-pagebuilder-wrapper-9698" class="mtheme-pagebuilder"><div class="mtheme-supercell clearfix ">				<div class="mtheme-cell-wrap" >
			...
			<div id="gridblock-container" class="portfolio-gutter-spaced  gridblock-three clearfix" data-columns="3">
    ...
    <?php 
      // echo $subcat; 
       $subcat = $_GET['subid'];
        ...
        $s2="SELECT * from product where product_category = '$subcat' and product_status = 1 ";
        $sl2=$db->prepare($s2);
        $sl2->execute();
 ...
 while($res4=$sl2->fetch(PDO::FETCH_ASSOC))
 {
     ...
     $pro_brand = $res4["product_brand"];

        $s22="SELECT brands_name from brands where brands_id = '$pro_brand' Limit 1";
        $sl22=$db->prepare($s22);
        $sl22->execute();
        $res42=$sl22->fetch(PDO::FETCH_ASSOC)

    ?>       
               
				<div class="gridblock-element isotope-displayed gridblock-element-id-11017 gridblock-element-order-1  gridblock-filterable filter-duvar-untesi " data-portfolio="portfolio-11017" data-id="id-2">
				<div class="gridblock-grid-element gridblock-element-inner" data-portfolioid="11017">
				<div class="gridblock-background-hover">
						<a data-thumbnail="admin/uploads/<?php echo $res4["product_pic"]; ?>" class="lightbox-active gridblock-sole-link column-gridblock-lightbox lightbox-image" data-sub-html="Pierro" href="admin/uploads/<?php echo $res4["product_pic"]; ?>" data-src="admin/uploads/<?php echo $res4["product_pic"]; ?>">
							<div class="gridblock-links-wrap box-title-false">
							<span class="column-gridblock-icon"><span class="hover-icon-effect">
							<i class="feather-icon-maximize"></i></span></span>
						    </div></a>
				</div>
						<img src="admin/uploads/<?php echo $res4["product_pic"]; ?>" style="height: 404px;width: 404px" alt="" class="displayed-image"/>
				</div>
					<div class="work-details"><div class="worktype-categories"><?php echo $res42["brands_name"]; ?></div><h4><a href=""><?php echo $res4["product_name"]; ?></a></h4><p class="entry-content work-description"></p></div></div>
...
<!--    <a  class="a2a_button_twitter" title="share to twitter"></a>-->
    <!--<a href="index.php" class="a2a_button_instagram" title="share to instagram"></a>-->
    <!-- <a class="a2a_dd" href="https://www.addtoany.com/share"></a> -->
       ...
       $('#catd-arab').hide();
		...
		jQuery(function($){	
			jQuery.supersized({
				...
				slides 					:  	[
		{image : 'images/bg5.jpeg', title : '<div class="fullscreen-slideshow-color" data-color="bright"></div><div class="slideshow-content-wrap background-slideshow-controls"><h1 class="slideshow_title slideshow_text_shift_up slideshow_title_animation">back-duvar-unitesi</h1></div>', thumb : '', url : ''}				],
				progress_bar			:	1,					
				mouse_scrub				:	1
			});
			if ($.fn.swipe) {
