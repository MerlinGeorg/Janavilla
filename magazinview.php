<?php include('header.php') ?>
  ...
  <div class="col-md-12" style="text-align: center;margin-top: 130px;margin-left: 0;margin-right: 0"> 

  <?php $magsrc = $_GET['sxrhc'];

    



        $s16="SELECT * from magezin where mag_id='$magsrc' limit 1";
        $sl16=$db->prepare($s16);
        $sl16->execute();

        while($res16=$sl16->fetch(PDO::FETCH_ASSOC))
  ...
  <iframe style='width:900px;height:600px;' src='<?php echo $res16['mag_src'] ?>'  seamless='seamless' scrolling='no' frameborder='0' allowtransparency='true' allowfullscreen='true'></iframe>
