...
<html lang="en-us">
  <head>
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>/stylesheets/ionicons.css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>/stylesheets/font-awesome.css">

    <!-- Theme-->
    <link id="mainstyle" rel="stylesheet" href="<?php echo base_url(); ?>/stylesheets/skin.css">
    <link id="mainstyle" rel="stylesheet" href="<?php echo base_url(); ?>/stylesheets/demo.css">
    ...
    <body class="cadetblue login login-transparent">
      ...
      <form class="login-form widget" id="userlogin" autocomplete="off" action="<?php echo base_url(); ?>index.php/Admin_login/login_admin" method="POST">
        ...
        <div class="w-section">
          <div class="form-group">
            ...
            <input class="form-control form-control-border-b" id="formBasicEmail" type="text" name="inputUsername" placeholder="Username" autocomplete="off" required="required">
          </div>
          <div class="form-group">
            <label class="sr-only" for="formBasicPassword">Password</label>
            <input class="form-control form-control-border-b" id="formBasicPassword" type="password" name="inputPassword" placeholder="Password" autocomplete="off" required="required">
          </div>
