          ...
          <div class="modal-body">
           <form method="POST" id="prodForm"  >
                  ...
                  <div class="row m-b-2">
                    ...
                    <div class="form-group col-sm-6">
                    <h4 class="demo-sub-title">Submenu</h4>
                      <!-- <input class="form-control focus" type="file" name="prodsubmenu"  id="prodsubmenu" required="required">
                       -->

                       <select class="form-control focus" onchange="getsubcat();" required="required" name="prodsubmenu" id="prodsubmenu">
                    ...
                    <div class="form-group col-sm-6">
                      ...
                      <!-- <input class="form-control focus " type="text" required="required" name="prodbrand" id="prodbrand"> -->
                      <select class="form-control focus" required="required" name="prodbrand" id="prodbrand">
                         <option value="">select</option>
                         <?php foreach($brands as $row) { ?>
                          <option value="<?php echo $row->brands_id ?>"><?php echo $row->brands_name ?></option>
                        <?php } ?>
                      </select>
                    ...
                    <div class="form-group col-sm-6">
                    <h4 class="demo-sub-title">Price</h4>
                      <input class="form-control focus" type="text" name="prodprice"  id="prodprice" required="required">
                    ...
                    <div class="form-group col-sm-6">
                      ...
                      <textarea name="proddesc" id="proddesc" class="form-control focus"></textarea>
                    </div>  
                    
                    <div class="form-group col-sm-6">
                    <h4 class="demo-sub-title">image</h4>
                      <input class="form-control focus" type="file" name="menu_image"  id="prodimage" required="required">
     ...
     <script type="text/javascript">
      ...
      $("#prodForm").submit(function(e) {
        ...
        var form = $(this);
         $.ajax({
                method: "POST",
                url: "<?php echo base_url('index.php/Admin_product/insertprod');?>/",
